...
class CassandraPlugin(object):
    ...
    def __str__(self):
        return "bottle_cassandra_plugin.CassandraPlugin(keyword=%r)" \
                % (self.keyword)
    ...
    def execute(self, cql_query, cql_query_params={}, consistency_level=None,
                timeout=10.0):
        ...
        return self.connection.execute(prep_query, parameters=cql_query_params,
                                       timeout=timeout)
